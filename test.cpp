...
int main() {
    ...
    const string testfile = "data_full/probe.dta.bin";
    const long N_movies = 17770;
    const long N_feature = 10;
    const long Korder = 5;
    const size_t recl = 4 * sizeof(int);
    int data_buffer[4] = {0, 0, 0, 0};

    //const string trainfile = "data.txt.training.bin";
    //const string testfile = "data.txt.testing.bin";
    //const long N_movies = 1682;
    //const long N_feature = 100;
    //const long Korder = 5;
    //int data_buffer[3] = {0, 0, 0};
    //const size_t recl = 3 * sizeof(int);
    ...
    rbm.loadState("states/savedRBM_010.h5");
    ...
    FILE *fout = fopen("predictions.txt", "w");
